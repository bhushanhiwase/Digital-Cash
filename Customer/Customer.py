...
sqlDatabase = MySQLdb.connect(host = "localhost", user = "root", passwd = "123456", db = "CustomerDetails")
...
def createMoneyOrders(accountNum, amount, moneyCount):
    ...
    AccountBalance = [item[2] for item in temp]

    string = str(custID[0]) + str(custName[0]) + str(AccountBalance[0])
